<%@page import="com.ez.wonder.member.model.MemberService"%>
...
<body>
	<h2>아이디 중복 검사</h2>
	<form name="frmId" method="post" action="<c:url value='/member/checkUserId'/>">
	
		<input type="text" name="flag" value="${param.flag }">
