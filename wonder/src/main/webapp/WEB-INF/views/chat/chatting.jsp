					...
					<div class="dash_user_menues">
						<ul>
							...
							<li><a href="my-property.html"><i class="fa fa-tasks"></i>My
									Properties</a></li>
							<li class="active"><a href="messages.html"><i
			...
			<div class="col-lg-9 col-md-8">
				...
				<div class="messages-container margin-top-0">
					<div class="messages-headline">
						...
						<a href="#" class="message-action"><i class="ti-trash"></i>
							...
							<ul>
								<li><a href="#">
										<div class="dash-msg-avatar">
											<img src="https://via.placeholder.com/500x500" alt=""><span
												class="_user_status online"></span>
										</div>
								...
								<li class="active-message"><a href="#">
										<div class="dash-msg-avatar">
											<img src="https://via.placeholder.com/500x500" alt=""><span
												class="_user_status offline"></span>
										</div>
						...
						<div class="dash-msg-content">
							...
							<div class="message-plunch">
								...
								<div class="dash-msg-text">
									<p>Hello, Contrary to popular belief, Lorem Ipsum is not
							...
							<div class="message-plunch me">
								...
								<div class="dash-msg-text">
									<p>please consider donating a small sum to help pay for the
										hosting and bandwidth bill.</p>
								</div>
							</div>
							...
							<div class="message-plunch me">
								...
								<div class="dash-msg-text">
									<p>numquam eius modi tempora incidunt ut labore et dolore
